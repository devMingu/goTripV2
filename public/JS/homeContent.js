...
const homeContent = [
  ...
  {
    title: ["단풍국의 아름다움 그리고 메이플 베어", "드라마 도깨비 촬영지", "멋진 스타일의 자연과 숙소"],
    img: "https://source.unsplash.com/collection/3109817/360x340",
  },
  {
    title: ["자유, 행복 그리고 아름다운 사랑이 있는 나라", "가장 다양한 인종이 모여사는 나라"],
    img: "https://source.unsplash.com/collection/8547261/360x340",
  },
  {
    title: ["아름다운 자연과 함께 떠나는 여행", "자연 그리고 사람 그 속 동물들", "모든 자연요소를 갖춘 멋진 장소", "한 폭의 그림같은 아름다움"],
