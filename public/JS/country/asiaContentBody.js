...
const asiaData = [
    ...
    },
    {
        ...
        description: "오타쿠 문화의 구성요소에는 게임, 만화, 피규어 컬렉션과 애니메이션이 있습니다. 이러한 서브컬처의 발상지는 뭐니 뭐니 해도 아키하바라입니다. 오타쿠들이 제각각 열중하는 가게가 많은 전기부품점 사이사이에 끼어 있습니다.",
        linkTag: "도쿄 관광청"
    },
    {
        recommand: 0,
        ...
        title: "신베이시 우라이 온천",
        description: "우라이(烏來)온천은 약 알칼리성 탄산온천으로 수질이 맑고 투명하여마실 수 있습니다. 2월초에는 우라이의 벚꽃이 만개하고, 후지 벚꽃, 붉은 벚꽃이 다투듯 피어나 온천과 함께 또 하나의 즐거움을 안겨줍니다.",
        linkTag: "대만 관광청"
    },
];
